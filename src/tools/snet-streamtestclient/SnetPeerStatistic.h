...
class SnetPeerStatistic: public SnetServiceMessage {
public:
    SnetPeerStatistic(): SnetServiceMessage(), m_RemoteSeed(0), m_LocalSeed(0), m_LocalGeneration(0), m_AmountOfPackets(0) {}
